#
# This makefile and the original sample app were taken from the maple-mini
# example supplied with ChibiOS
#
# ATTENTION: Be sure to set the CHIBIOS variable (around line 100) to point to your local installation of ChibiOS
#
##############################################################################
